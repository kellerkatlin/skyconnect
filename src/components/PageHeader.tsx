...
export const HEADS: Record<string, { eyebrow: string; title: string; sub: string }> = {
  ...
  buscar: {
    ...
    sub: 'Calcula rutas con 0, 1 y 2 escalas evaluando A, A² y A³, o usa el Planificador para comparar opciones por costo y tiempo.',
  },
  stats: {
    eyebrow: '05 · Análisis',
  ...
  agregar: {
    ...
    sub: 'Modifica la red en vivo. Las matrices A, A² y A³ se recalculan automáticamente.',
  },
};
